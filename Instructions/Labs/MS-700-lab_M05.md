...
3. Sign in to the Teams web client (https://teams.microsoft.com/) using LynneR@YourTenant.onmicrosoft.com.
...
4. Sign in to the Teams web client (https://teams.microsoft.com/) using LynneR@YourTenant.onmicrosoft.com.
...
2. Sign in to the Teams web client https://teams.microsoft.com using LynneR@YourTenant.onmicrosoft.com.
...
1. Sign in to the Teams web client https://teams.microsoft.com using LynneR@YourTenant.onmicrosoft.com.
